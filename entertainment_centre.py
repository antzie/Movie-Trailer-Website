...
black_hawk_down = media.Movie("Black Hawk Down",
                              "The Battle of Mogadishu, fought between US Special Forces and Somali militia fighters",
                              'https://upload.wikimedia.org/wikipedia/en/thumb/0/0c/Black_hawk_down_ver1.jpg/220px-Black_hawk_down_ver1.jpg',
                              "https://www.youtube.com/watch?v=5Y1ju8QwpQM",
                              '76%',
                              'Ridley Scott',
...
darkest_hour = media.Movie("The Darkest Hour",
                           "The story of Britain's leaders during the retreat to Dunkirk and the decisions they faced",
                           "https://upload.wikimedia.org/wikipedia/en/3/38/Darkest_Hour_poster.png",
...
the_man_from_nowhere = media.Movie("The Man From Nowhere",
                                   "When a little girl is kidnapped by gangs, a mysterious pawn shop owner goes after her",
                                   "https://upload.wikimedia.org/wikipedia/en/thumb/d/d6/The_Man_from_Nowhere_poster.jpg/220px-The_Man_from_Nowhere_poster.jpg",
...
fresh_tomatoes_ver3.open_movies_page(movies)
